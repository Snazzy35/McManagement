...
def install_paper(MCV, MCP):
    if MCV == 8:
        subprocess.run(["wget", "-P", MCP, "https://api.papermc.io/v2/projects/paper/versions/1.8.8/builds/445/downloads/paper-1.8.8-445.jar"])
    elif MCV == 9:   
        subprocess.run(["wget", "-P", MCP, "https://api.papermc.io/v2/projects/paper/versions/1.9.4/builds/775/downloads/paper-1.9.4-775.jar"])
    elif MCV == 10:
        subprocess.run(["wget", "-P", MCP, "https://api.papermc.io/v2/projects/paper/versions/1.10.2/builds/918/downloads/paper-1.10.2-918.jar"])
    elif MCV == 11:
        subprocess.run(["wget", "-P", MCP, "https://api.papermc.io/v2/projects/paper/versions/1.11.2/builds/1106/downloads/paper-1.11.2-1106.jar"])
    elif MCV == 12:
        subprocess.run(["wget", "-P", MCP, "https://api.papermc.io/v2/projects/paper/versions/1.12.2/builds/1620/downloads/paper-1.12.2-1620.jar"])
    elif MCV == 13:
        subprocess.run(["wget", "-P", MCP, "https://api.papermc.io/v2/projects/paper/versions/1.13.2/builds/657/downloads/paper-1.13.2-657.jar"])
    elif MCV == 14:
        subprocess.run(["wget", "-P", MCP, "https://api.papermc.io/v2/projects/paper/versions/1.14.4/builds/245/downloads/paper-1.14.4-245.jar"])
    elif MCV == 15:
        subprocess.run(["wget", "-P", MCP, "https://api.papermc.io/v2/projects/paper/versions/1.15.2/builds/393/downloads/paper-1.15.2-393.jar"])
    elif MCV == 16:
        subprocess.run(["wget", "-P", MCP, "https://api.papermc.io/v2/projects/paper/versions/1.16.5/builds/794/downloads/paper-1.16.5-794.jar"])
    elif MCV == 17:
        subprocess.run(["wget", "-P", MCP, "https://api.papermc.io/v2/projects/paper/versions/1.17.1/builds/411/downloads/paper-1.17.1-411.jar"])
    elif MCV == 18:
        subprocess.run(["wget", "-P", MCP, "https://api.papermc.io/v2/projects/paper/versions/1.18.2/builds/388/downloads/paper-1.18.2-388.jar"])
    elif MCV == 19:
        subprocess.run(["wget", "-P", MCP, "https://api.papermc.io/v2/projects/paper/versions/1.19.4/builds/550/downloads/paper-1.19.4-550.jar"])
    elif MCV == 20:
        subprocess.run(["wget", "-P", MCP, "https://api.papermc.io/v2/projects/paper/versions/1.20.6/builds/134/downloads/paper-1.20.6-134.jar"])
    else:
